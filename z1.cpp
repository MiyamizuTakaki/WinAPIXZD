...
void setText(HWND hwnd, int width, int height, RECT rect) {
    ...
    HBRUSH hBrush = CreateSolidBrush(RGB(5, 4, 82));
    auto hOldBrush = (HBRUSH)SelectObject(memdc, hBrush);
    ...
    SetBkMode(memdc, TRANSPARENT);
    DrawText(memdc, TEXT("System Error! Code:0x000000C"), -1, &rect, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
